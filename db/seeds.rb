...
p1 = Post.new(content: text1, request: true, isPrivate: false, category: 'request', user: user1)
p1.save!

text2 = 'Do you not know that you are the temple of God and that the Spirit of God dwells in you?'
p2 = Post.new(content: text2, request: true, isPrivate: false, category: 'request', user: user2)
p2.save!
...
p3 = Post.new(content: text3, request: true, isPrivate: true, category: 'request', user: user3)
p3.save!
...
p4 = Post.new(content: text4, testimonial: true, isPrivate: false, category: 'testimonial', user: user1)
p4.save!
...
p5 = Post.new(content: text5, testimonial: true, isPrivate: false, category: 'testimonial', user: user1)
p5.save!

text6 = 'Blessed is the man who trusts in the LORD, And whose hope is the LORD.'
p6 = Post.new(content: text6, request: true, isPrivate: false, category: 'request', user: user3)
p6.save!
